...
var TagCreate = React.createClass({
  ...
  componentWillMount: function() {
    this.listenTo(TagStore, this.onTagCreate);
  },
  ...
  disableForm: function() {
    ...
    this.refs.oz.getDOMNode().disabled = 'disabled';
          ...
          <div className="panel-body">
            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="form-group">
                ...
                <input ref="dom_id" type="text" className="form-control" id="dom_id" placeholder="Accepted values: numbers, letters, special characters(- _ .). No spaces allowed." data-parsley-pattern="^[A-Za-z0-9_\-\.]+$" required/>
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <textarea ref="on_load" id="on_load" className="form-control" rows="3"></textarea>
              </div>
